...
This is a Wi-Fi–controlled ESP32 RC car for a high-school STEM bootcamp (~28 students). Custom PCB integrates motor drive and battery power management; students drive the car from a phone over an ESP32-hosted website.
