// Baud-tick counter: pulses done for 1 cycle when en has been high for max_count clocks.
module counter #(
...
// 8N1 UART receiver: idle-high, start bit low, 8 data bits LSB first, stop bit high.
module uart_rx #(
